...
#define PLEX_EXTRADATA_LOADER 99996
...
#define LISTITEM_STAR_DIFFUSE       (LISTITEM_START + 153)
#define LISTITEM_BANNER             (LISTITEM_START + 154)
#define LISTITEM_FIRST_GENRE        (LISTITEM_START + 155)
